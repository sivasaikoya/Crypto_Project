    ...
    <div id="root">
        ...
        <div class="top-section">
            ...
            <div class="encrypt_decrypt_section">
                ...
                <form action="aes_encrypt">
                <label class="select_size label2" for="manual-public-key">Enter Key</label>
                <textarea class="key_box size2" id="manual-public-key" rows="1" cols="50" placeholder="Enter Key" name="key">${sharedkey}</textarea>
                ...
                <textarea class="key_box size2" id="plain-text" rows="4" cols="50" placeholder="Result">${ct}</textarea>
            </div>
        </div>
        ...
        <div class="bottom-section ">
            ...
            <div class="rsa_enc_dec_in">
                ...
                <form action="aes_decrypt">
                <label class="select_size label2" for="manual-private-key">Enter Key</label>
                <textarea class="key_box size2" id="manual-private-key" rows="1" cols="50" placeholder="Enter Key" name="key">${sharedkey}</textarea>
            ...
            <div class="rsa_enc_dec_in">
                ...
                <textarea class="result_output" id="result" readonly placeholder="The result will appear here">${pt}</textarea>
